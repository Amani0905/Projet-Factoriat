...
const PartenersFactoriat = () => {
  return (
    ...
    <div className="partner-logo col-2"><a href="http://www.mfcpole.com.tn/Fr/association-tunisia-technoparks_11_127" target="_blank"><img style={{height:'150px',width:'250px'}} src={require("../styles/img/logo_ATT.png")} /></a></div>
...
<div style={{paddingBottom:20}} id="logo-grid">
<div className="partner-logo"><a href="https://innovi.tn/" target="_blank"><img src={require("../styles/img/Logo Black.png")} /></a></div>
<div className="partner-logo col-2"><a  target="_blank"><img style={{height:'130px',width:'180px'}}src={require("../styles/img/eu.png")} /></a></div>
