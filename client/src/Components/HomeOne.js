...
const HomeOne = () => {
  return (
    ...
    <span style={{fontSize:'20px',color:'#ffc80a',fontWeight:'900',backgroundColor:'rgba(60, 60, 60, 0.5)',paddingTop:'6px',paddingBottom:'5.5px'}}>Projet de soutien aux startups issues des résultats de la recherche scientifique</span> </label>
    <label className="One" htmlFor="hearts"><span style={{backgroundColor:'black'}}>TECHNORIAT</span>
    <span style={{fontSize:'20px',color:'#ffc80a',fontWeight:'900',backgroundColor:'rgba(60, 60, 60, 0.5)',paddingTop:'6px',paddingBottom:'5.5px'}}>a pour objectif de poser les fondements nécessaires au développement d'un écosystème de l'innovation en Tunisie</span></label>
    <label className="One" htmlFor="spades"><span style={{backgroundColor:'black'}}>FACTORIAT</span><span style={{fontSize:'20px',color:'#ffc80a',fontWeight:'900',backgroundColor:'rgba(60, 60, 60, 0.5)',paddingTop:'6px',paddingBottom:'5.5px'}}>Pilier prototypage industriel du Programme TECHNORIAT</span></label>
